...
type ClientDisconnect struct {
	...
	Sess        *Session `protobuf:"bytes,1,opt,name=sess,proto3" json:"sess,omitempty"`
	OwnEntityID string   `protobuf:"bytes,2,opt,name=ownEntityID,proto3" json:"ownEntityID,omitempty"`
}
...
func (x *ClientDisconnect) GetSess() *Session {
	if x != nil {
		return x.Sess
	}
	return nil
...
var file_session_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x44, 0x22, 0x59, 0x0a, 0x10, 0x43, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12, 0x23,
	0x0a, 0x04, 0x73, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70,
