...
// Source: github.com/tutumagi/pitaya/cluster (interfaces: RPCServer,RPCClient,SDListener,InfoRetriever,RemoteBindingListener)
...
func (mr *MockRPCClientMockRecorder) Post(arg0, arg1, arg2, arg3, arg4, arg5 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Post", reflect.TypeOf((*MockRPCClient)(nil).Post), arg0, arg1, arg2, arg3, arg4, arg5)
}
